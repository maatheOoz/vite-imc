...
export default ({ imc }) => {
    const classification = [
        ...
        },
        {
            ...
            description: 'Obesidade I e II'
        },
        {
            min: 40,
            max: 100,
            imc: 'maior que 40,0',
            description: 'Obesidade Extrema'
        }
    ]
        ...
        for (let idx = 0; idx < classification.length; idx++) {
            ...
            if (imc > item.min && imc < item.max) {
                ...
                element.forEach((line) => {
                    line.style.backgroundColor = '#580';
        ...
        <Row className='justify-content-center mt-5'>
            <Col xs={5}>
                <Table bordered>
                    <thead>
                        <tr>
                            <th colSpan={2} className='text-center' style={{ backgroundColor: '#59C', color: 'white' }}>
